...
urlpatterns = [
    ...
    path('tweets/', views.tweet_list, name='Tweet List'),
    path('tweets/', views.tweet_fetch, name='Tweet Fetch'),
    path('tweets/', views.tweet_set_active, name='Tweet Set Active'),
    path('tweets/', views.tweet_set_inactive, name='Tweet Set Inactive'),
